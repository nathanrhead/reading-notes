...
IV. Main HTML elements
    ...
    B. <head>: metadata for the browser
        1. Comes before the body;
        2. Contains info about the page, e.g. <title>, which will display a title on the tab of the page.    
...
IV. Elements that are used to group together parts of the page where no other element is suitable
    ...
    A. <div>: block-level container
        1. "For example, you might create a <div> element to contain all of the elements for the header of your site (the logo and the navigation), or you might create a <div> element to contain comments from visitors."
        2. "It can also make it easier to follow your code if you have used <div> elements to hold each section of the page."
        3. "Since there may be several other elements inside a <div> element, it can be helpful to add a comment after the closing </div> tag."
...
V. How to embed a page within a page using iframes
    ...
    D. "There are a few attributes that you will need to know to use it":
        ...
        4. scrolling: "The scrolling attribute will not be supported in HTML5. In HTML 4 and XHTML, it indicates whether the iframe should have scrollbars or not. This is important if the page inside the iframe is larger than the space you have allowed for it (using the height and width attributes)."
        5. frameborder: "The frameborder attribute will not be supported in HTML5. In HTML 4 and XHTML, it indicates whether the frame should have a border or not."
        6. seamless: "In HTML5, a new attribute called seamless can be applied to an iframe where scrollbars are not desired. The seamless attribute (like some other new HTML5 attributes) does not need a value, but you will often see authors give it a value of seamless. Older browsers do not support the seamless attribute."
...
VI. How to add information about the web page using the `<meta>` element
    ...
    E. "The value of the name attribute can be anything you want it to be. Some defined values for this attribute that are commonly used are:"
        1. description: "This contains a description of the page. This description is commonly used by search engines to understand what the page is about and should be a maximum of 155 characters. Sometimes it is also displayed in search engine results."
        2. keywords: "This contains a list of comma- separated words that a user might search on to find the page. In practice, this no longer has any noticeable effect on how search engines index your site."
        3. robots: "This indicates whether search engines should add this page to their search results or not. A value of noindex can be used if this page should not be added. A value of nofollow can be used if search engines should add this page in their results but not any pages that it links to."
...
II. Elements
    ...
    D. <aside>: "has two purposes, depending on whether it is inside an <article> element or not":
        1. inside: "it should contain information that is related to the article but not essential to its overall meaning. For example, a pullquote or glossary might be considered as an aside to the article it relates to."
        2. outside: "it acts as a container for content that is related to the entire page. For example, it might contain links to other sections of the site, a list of recent posts, a search box, or recent tweets by the author."
...
II. Motives: why your site's visitors come.
    ...
    A. Motivations
        1. General entertainment or a specific aim?
        2. If an aim: personal or professional?
        3. Is the visit essential or optional? 
    B. Goals
        1. General research or a specific aim?
        2. Known product or needs an introduction?
        3. Looking for time-sensitive information? 
        4. Looking for info on a product or service to help them decide whether to purchase? 
        5. Looking for contact information? If so, in person or remotely? 
...
VI. Design: "Organizing and prioritizing information on a page helps users understand its importance and what order to read it in."
    ...
    C. Organizing by grouping: "Grouping together related content into blocks or chunks makes the page look simpler (and easier to understand)."
        1. Proximity
        2. Closure: "A real or imaginary box can be formed around elements due to their proximity and alignment."
        3. Continuance: "When elements are placed in a line or a curve then they are perceived to be more related than those that are not following the same direction."
        4. White space: "Placing related items closer together and leaving a bigger gap between unrelated items."
        5. Background color: "A background color placed behind related items to emphasize their connection."
        6. Borders
...
I. I. Pages 1 - 12: Intro
    ...
    B. JS makes web pages more interactive by accessing and modifying the content of the webpage while in use. 
        1. **Accessing* content: "You can use JavaScript to select any element, attribute, or text from an HTML "
        2. **Modifying** content: "You can use JavaScript to add elements, attributes, and text to the page, or remove them."
        ...
        4. **Reacting** to events: "You can specify that a script should run when a specific event has occurred.
